...
users.forEach((user, index) => {
    ...
    test(`Frontend Login - ${user.mobile}`, async ({ page, loginPage, homePage, productPage, cartPage, addressPage, paymentPage, threeDSPage, thankYouPage, MyOrderPage, OrderinfoPage }) => {
